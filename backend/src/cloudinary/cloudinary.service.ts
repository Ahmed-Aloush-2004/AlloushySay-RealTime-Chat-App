...
// //                 { resource_type: 'auto' }, // Detect file type automatically (image, video, raw)
// //                 (error, result) => {
...
//                 { 
//                     resource_type: 'auto',
//                     folder: 'chat-files-app', // Optional: Use a specific folder
//                 },
...
//                     }
//                     // Resolve with the secure URL and public ID (essential for deletion)
//                     resolve({
